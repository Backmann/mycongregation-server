...
export class InitSchema1777910402580 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cb5653e0842d8e5f3d3759df70" ON "users" ("congregation_id") `);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_cb5653e0842d8e5f3d3759df70c" FOREIGN KEY ("congregation_id") REFERENCES "congregations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_cb5653e0842d8e5f3d3759df70c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_cb5653e0842d8e5f3d3759df70"`);
