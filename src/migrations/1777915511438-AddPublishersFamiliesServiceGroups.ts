...
export class AddPublishersFamiliesServiceGroups1777915511438 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_62576102282da1664ec7072be1" ON "service_groups" ("congregation_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_24c0c48a4f58d775f4777be388" ON "service_groups" ("overseer_publisher_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_fb3eca7d3fd9bf9412ca0d85f8" ON "service_groups" ("assistant_publisher_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."publishers_gender_enum" AS ENUM('brother', 'sister')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."publishers_appointment_enum" AS ENUM('elder', 'ministerial_servant', 'publisher', 'unbaptized_publisher', 'none')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."publishers_pioneer_type_enum" AS ENUM('none', 'auxiliary_until_cancelled', 'regular', 'special', 'missionary')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."publishers_removal_reason_enum" AS ENUM('moved', 'disfellowshipped', 'died', 'other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_022658ed9d063307aab18f993a" ON "publishers" ("congregation_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1c323eff2662e2bfaecc0ceb1f" ON "publishers" ("family_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_476996479b2a21d5f70c6b13ac" ON "publishers" ("service_group_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1d34de8ae0ebdc6e72229e34c8" ON "publishers" ("last_name", "first_name") `,
    );
    await queryRunner.query(
      `ALTER TABLE "service_groups" ADD CONSTRAINT "FK_62576102282da1664ec7072be19" FOREIGN KEY ("congregation_id") REFERENCES "congregations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "publishers" ADD CONSTRAINT "FK_022658ed9d063307aab18f993a4" FOREIGN KEY ("congregation_id") REFERENCES "congregations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "publishers" ADD CONSTRAINT "FK_40c3defdcca3616fd21ede9063d" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "publishers" ADD CONSTRAINT "FK_476996479b2a21d5f70c6b13ac8" FOREIGN KEY ("service_group_id") REFERENCES "service_groups"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "publishers" DROP CONSTRAINT "FK_476996479b2a21d5f70c6b13ac8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "publishers" DROP CONSTRAINT "FK_1c323eff2662e2bfaecc0ceb1f1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "publishers" DROP CONSTRAINT "FK_40c3defdcca3616fd21ede9063d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "publishers" DROP CONSTRAINT "FK_022658ed9d063307aab18f993a4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "families" DROP CONSTRAINT "FK_62e86cb97d1269f10eca082cbe8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_groups" DROP CONSTRAINT "FK_62576102282da1664ec7072be19"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1d34de8ae0ebdc6e72229e34c8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_476996479b2a21d5f70c6b13ac"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1c323eff2662e2bfaecc0ceb1f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_022658ed9d063307aab18f993a"`,
    );
    await queryRunner.query(`DROP TABLE "publishers"`);
    await queryRunner.query(
      `DROP TYPE "public"."publishers_removal_reason_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."publishers_pioneer_type_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a9a4435dc7d9fae1ea29933c8e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_62e86cb97d1269f10eca082cbe"`,
    );
    await queryRunner.query(`DROP TABLE "families"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fb3eca7d3fd9bf9412ca0d85f8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_24c0c48a4f58d775f4777be388"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_62576102282da1664ec7072be1"`,
    );
